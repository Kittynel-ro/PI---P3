...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        abs_num.setText(String.valueOf(140 - getStudentsNum())); // set number of absent students in last class label
        double percent = (((double) getStudentsNum() * 100 / (double) 140));
